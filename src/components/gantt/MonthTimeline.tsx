import { startOfMonth, endOfMonth, differenceInMinutes, format, isSameMonth } from "date-fns";
  ...
  return (
    <div className="relative h-full">
      <div
        ...
        title={`From ${item.start.toLocaleDateString()} to ${item.end.toLocaleDateString()}`}
      />
      <div
        className="absolute top-0 bottom-0 w-1 bg-yellow-500 z-20"
        style={{ left: `${duePercentage}%` }}
        title={`Due: ${item.due.toLocaleDateString()}`}
      />
